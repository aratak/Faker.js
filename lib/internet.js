...
var fs = require('fs');
var userAgents = JSON.parse(fs.readFileSync(path.join(process.cwd(), '/resources/allagents.json')));
...
exports.userAgent = function() {
  return userAgents[(Math.random() * (userAgents.length-1)).toFixed(0)]['String']
}
